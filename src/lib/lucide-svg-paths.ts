/**
 * Chemins SVG des icônes Lucide couramment utilisées dans les templates
 * Utilisé par pdf-html-generator.ts pour le rendu inline des icônes
 * 
 * Pour ajouter une nouvelle icône :
 * 1. Trouver le SVG sur https://lucide.dev/icons/
 * 2. Copier le contenu interne du <svg> (les <path>, <circle>, etc.)
 * 3. Ajouter l'entrée avec le nom PascalCase de l'icône
 */

export const LUCIDE_SVG_PATHS: Record<string, string> = {
  // Services CybertekPro - Page 7
  Recycle: '<path d="M7 19H4.815a1.83 1.83 0 0 1-1.57-.881 1.785 1.785 0 0 1-.004-1.784L7.196 9.5"/><path d="M11 19h8.203a1.83 1.83 0 0 0 1.556-.89 1.784 1.784 0 0 0 0-1.775l-1.226-2.12"/><path d="m14 16-3 3 3 3"/><path d="M8.293 13.596 4.875 9.5l-4.267 3.798"/><path d="m13 7 3-3-3-3"/><path d="M12 20V10"/><path d="M16.103 6.5 13.5 2.099a1.784 1.784 0 0 0-3.002 0l-2.603 4.401"/>',
  ...
  // ===== Icônes supplémentaires pour Page 7 (Services CybertekPro) =====
  
  // Flèches circulaires - Reprise et Reconditionnement
  ...
  ShieldQuestion: '<path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/><path d="M9.1 9a3 3 0 0 1 5.82 1c0 2-3 3-3 3"/><path d="M12 17h.01"/>',
  ...
  // Transport
  TruckIcon: '<path d="M10 17h4V5H2v12h3"/><path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5v8h1"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/>',
  ...
  // ===== Icônes manquantes identifiées pour Page 7 =====
  ...
  HeartHandshake: '<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/><path d="M12 5.5c.5.5 1 1.5 1 2.5 0 1.5-1 2-1 2s-1-.5-1-2c0-1 .5-2 1-2.5z"/><path d="M8.5 8.5c.5-.5 1.5-.5 2 0 .5.5.5 1.5 0 2-.5.5-1.5.5-2 0-.5-.5-.5-1.5 0-2z"/><path d="M13.5 8.5c.5-.5 1.5-.5 2 0 .5.5.5 1.5 0 2-.5.5-1.5.5-2 0-.5-.5-.5-1.5 0-2z"/>',
};

/**
 * Génère le HTML SVG inline pour une icône Lucide
 * @param iconName Nom de l'icône (PascalCase, ex: "Shield")
 * @param size Taille en pixels
 * @param color Couleur stroke (ex: "#1f2937")
 * @param strokeWidth Épaisseur du trait (défaut: 2)
 * @returns String HTML du SVG ou placeholder si icône non trouvée
 */
export function renderIconSVG(
  ...
  if (!path) {
    ...
    console.warn(`[PDF Export] Missing SVG path for icon: "${iconName}". Add it to LUCIDE_SVG_PATHS in src/lib/lucide-svg-paths.ts`);
    // Placeholder visuel pour debug
    return `<span style="display:inline-flex;align-items:center;justify-content:center;width:${size}px;height:${size}px;background:#e5e7eb;border-radius:50%;font-size:${Math.max(size * 0.4, 8)}px;color:#6b7280;">?</span>`;
  }
